...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var _modules_jquery_3_6_1_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/jquery-3.6.1.min.js */ \"./src/js/modules/jquery-3.6.1.min.js\");\n/* harmony import */ var _modules_bootstrap_bundle_min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/bootstrap.bundle.min.js */ \"./src/js/modules/bootstrap.bundle.min.js\");\n/* harmony import */ var _modules_nouislider_min_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/nouislider.min.js */ \"./src/js/modules/nouislider.min.js\");\n/* harmony import */ var air_datepicker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! air-datepicker */ \"./node_modules/air-datepicker/index.es.js\");\n/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components.js */ \"./src/js/components.js\");\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.esm.js\");\n\n\n\n\n\n\n\n\n\n\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\n\n\n\n// Import swiper\n\nswiper__WEBPACK_IMPORTED_MODULE_6__[\"default\"].use([swiper__WEBPACK_IMPORTED_MODULE_6__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_6__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_6__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_6__.Mousewheel, swiper__WEBPACK_IMPORTED_MODULE_6__.EffectFade, swiper__WEBPACK_IMPORTED_MODULE_6__.Thumbs, swiper__WEBPACK_IMPORTED_MODULE_6__.Scrollbar]);\n\n// let inputs = document.querySelectorAll('input[type=\"tel\"]');\n// let im = new Inputmask('+7 (999) 999-99-99');\n// im.mask(inputs);\n\n// Burger\nconst btnMenu = document.querySelector('#toggle');\nlet btnMenuClose = document.querySelector('.btn-close');\nconst menu = document.querySelector('.header__nav');\nconst bodyEl = document.querySelector('body');\nlet navItemAll = document.querySelectorAll('.header__nav-list li a');\nlet catalogHeader = document.querySelector('.header-catalog');\nlet brandHeader = document.querySelector('.header-brand');\nlet btnCatalog = document.querySelector('.header-category__wrapper');\nlet btnBrand = document.querySelector('.brand-btn');\nlet inputSearchForm = document.querySelector('.header-form input');\nlet btnSearchForm = document.querySelector('.header-form button');\nlet searchContent = document.querySelector('.header-form-content');\nlet searchBtn = document.querySelector('.search-btn-header');\nlet searchBtnFixed = document.querySelector('.search-btn-fixed');\nlet headerForm = document.querySelector('.header-form');\nlet headerFormMobileClose = document.querySelector('.header-form-close');\nlet headerCatalogBtn = document.querySelector('.header-catalog__button');\nlet headerBrandBtn = document.querySelector('.header-brand__button');\nlet headerFormClearBtn = document.querySelector('.header-form-clear');\nlet catalogFixedBtn = document.querySelector('.catalog-fixed-btn');\nlet shopSidebarOverlay = document.querySelector('.shop-sidebar-overlay');\n\n\nconst menuLine1 = document.querySelector('.top-bun');\nconst menuLine2 = document.querySelector('.meat');\nconst menuLine3 = document.querySelector('.bottom-bun');\n\nconst toggleMenu = function () {\n  menu.classList.toggle('open');\n}\nconst toggleBurger = function () {\n  btnMenu.classList.toggle('active');\n}\nconst closeAllMenu = function () {\n  let arrowMenuAll = document.querySelectorAll('.arrow-btn-more');\n  arrowMenuAll.forEach(el => {\n    let elPar = el.closest('li.has-child');\n    let elContent = elPar.querySelector('.header__nav-subcat-wrapper ');\n    let elContentClassActive = elContent.classList.contains(\"active\");\n    if (elContentClassActive) {\n      elContent.classList.remove('active');\n    }\n  });\n}\nconst toggleMenuLine = function () {\n  menuLine1.classList.toggle('active');\n  menuLine2.classList.toggle('active');\n  menuLine3.classList.toggle('active');\n}\nconst bodyOverflow = function () {\n  bodyEl.classList.toggle('hidden');\n}\nbtnMenu?.addEventListener('click', function (e) {\n  closeAllMenu();\n  e.stopPropagation();\n  toggleMenu();\n  toggleBurger();\n  bodyOverflow();\n  toggleMenuLine();\n});\nbtnMenuClose.addEventListener('click', function (e) {\n  closeAllMenu();\n  e.stopPropagation();\n  toggleMenu();\n  toggleBurger();\n  bodyOverflow();\n  toggleMenuLine();\n});\n\n// Menu show\ndocument.addEventListener('click', function (e) {\n  const target = e.target;\n  const its_catalogHeader = target == catalogHeader || catalogHeader.contains(target);\n  const its_btnCatalog = target == btnCatalog || btnCatalog.contains(target);\n  const its_brandHeader = target == brandHeader || brandHeader.contains(target);\n  const its_btnBrand = target == btnBrand || btnBrand.contains(target);\n  const its_inputSearch = target == inputSearchForm || inputSearchForm.contains(target);\n  const its_searchContent = target == searchContent || searchContent.contains(target);\n  const its_searchBtn = target == searchBtn || searchBtn.contains(target);\n  const its_btnSearchForm = target == btnSearchForm || btnSearchForm.contains(target);\n  const its_headerFormClearBtn = target == headerFormClearBtn || headerFormClearBtn.contains(target);\n  const catalogHeader_is_active = catalogHeader.classList.contains('active');\n  const brandHeader_is_active = brandHeader.classList.contains('active');\n\n  if (!its_catalogHeader && catalogHeader_is_active && !its_btnCatalog) {\n    catalogHeader.classList.remove('active');\n    btnCatalog.classList.remove('active');\n  }\n  if (!its_brandHeader && brandHeader_is_active && !its_btnBrand) {\n    brandHeader.classList.remove('active');\n    // btnBrand.classList.remove('active');\n  }\n  if (!its_inputSearch && !its_searchContent && !its_searchBtn && !its_btnSearchForm && !its_headerFormClearBtn) {\n    searchContent.classList.remove('active');\n    headerForm.classList.remove('active-btn');\n  }\n\n});\n\n\nbtnCatalog.addEventListener('click', () => {\n  catalogHeader.classList.toggle('active');\n});\nbtnBrand.addEventListener('click', () => {\n  brandHeader.classList.toggle('active');\n});\n\ninputSearchForm.addEventListener('click', () => {\n  searchContent.classList.add('active');\n  headerForm.classList.add('active-btn');\n});\n\nsearchBtn.addEventListener('click', () => {\n  headerForm.classList.add('active');\n  inputSearchForm.focus();\n  inputSearchForm.click();\n});\n\nsearchBtnFixed.addEventListener('click', () => {\n  headerForm.classList.add('active');\n  inputSearchForm.focus();\n\n  setTimeout(() => {\n    inputSearchForm.click();\n  }, 200);\n});\n\nheaderFormMobileClose.addEventListener('click', () => {\n  headerForm.classList.remove('active');\n});\n\nheaderCatalogBtn?.addEventListener('click', () => {\n  catalogHeader.classList.remove('active');\n});\n\nheaderBrandBtn?.addEventListener('click', () => {\n  brandHeader.classList.remove('active');\n});\n\nheaderFormClearBtn?.addEventListener('click', () => {\n  inputSearchForm.value = '';\n});\n\ncatalogFixedBtn?.addEventListener('click', (e) => {\n  closeAllMenu();\n  e.stopPropagation();\n  toggleMenu();\n  toggleBurger();\n  bodyOverflow();\n  toggleMenuLine();\n});\n\n\nlet filterBtn = document.querySelector('.filter-btn');\nlet sidebarItem = document.querySelector('.shop-sidebar');\nlet sidebarBtnClose = document.querySelector('.shop-sidebar__head-close');\n\nfilterBtn?.addEventListener('click', () => {\n  sidebarItem.classList.add('active');\n  shopSidebarOverlay.classList.add('active');\n  bodyOverflow();\n\n});\nsidebarBtnClose?.addEventListener('click', () => {\n  sidebarItem.classList.remove('active');\n  shopSidebarOverlay.classList.remove('active');\n  bodyOverflow();\n});\n\nshopSidebarOverlay?.addEventListener('click', () => {\n  sidebarItem.classList.remove('active');\n  shopSidebarOverlay.classList.remove('active');\n  bodyOverflow();\n});\n\n\n// Инициализация слайдера intro-slider\nconst introSlider = document.querySelector('.intro-slider');\nvar mySwiperIntro = new swiper__WEBPACK_IMPORTED_MODULE_6__[\"default\"](introSlider, {\n  slidesPerView: 1,\n  spaceBetween: 10,\n  loop: false,\n  autoplay: {\n    delay: 5000,\n  },\n  speed: 600,\n  autoplay: {\n    delay: 4000,\n  },\n  allowTouchMove: true,\n  navigation: {\n    nextEl: '.intro-slider .nav-arrow-right',\n    prevEl: '.intro-slider .nav-arrow-left',\n  },\n});\n\n\n// Инициализация слайдера product-slider\ndocument.querySelectorAll('.product-sect').forEach(n => {\n  const mySwiperProduct = new swiper__WEBPACK_IMPORTED_MODULE_6__[\"default\"](n.querySelector('.product-slider'), {\n    slidesPerView: 6,\n    spaceBetween: 20,\n    autoplay: {\n      delay: 5000,\n    },\n    speed: 600,\n    autoplay: {\n      delay: 4000,\n    },\n    navigation: {\n      prevEl: n.querySelector('.nav-arrow-left'),\n      nextEl: n.querySelector('.nav-arrow-right'),\n    },\n    breakpoints: {\n      0: {\n        slidesPerView: 1,\n        spaceBetween: 8,\n      },\n      360: {\n        slidesPerView: 2,\n        spaceBetween: 8,\n      },\n      576: {\n        slidesPerView: 2,\n        spaceBetween: 8,\n      },\n      768: {\n        slidesPerView: 3,\n        spaceBetween: 8,\n      },\n      992: {\n        slidesPerView: 4,\n      },\n      1200: {\n        slidesPerView: 6,\n        spaceBetween: 20,\n      },\n    },\n  });\n});\n\n// Инициализация слайдера brand-slider\nconst brandSlider = document.querySelector('.brand-slider');\nvar mySwiperBrand = new swiper__WEBPACK_IMPORTED_MODULE_6__[\"default\"](brandSlider, {\n  slidesPerView: 10,\n  spaceBetween: 20,\n  autoplay: {\n    delay: 5000,\n  },\n  speed: 600,\n  autoplay: {\n    delay: 4000,\n  },\n  allowTouchMove: true,\n  navigation: {\n    nextEl: '.brand .nav-arrow-right',\n    prevEl: '.brand .nav-arrow-left',\n  },\n  breakpoints: {\n    0: {\n      slidesPerView: 3,\n      spaceBetween: 8,\n    },\n    380: {\n      slidesPerView: 4,\n      spaceBetween: 8,\n    },\n    576: {\n      slidesPerView: 5,\n    },\n    768: {\n      slidesPerView: 6,\n    },\n    992: {\n      slidesPerView: 7,\n      spaceBetween: 10,\n    },\n    1200: {\n      slidesPerView: 9,\n      spaceBetween: 20,\n    },\n    1450: {\n      slidesPerView: 10,\n      spaceBetween: 20,\n    },\n  },\n});\n\n// blog-slider\nconst blogSlider = document.querySelector('.blog-slider');\nvar mySwiperBrand = new swiper__WEBPACK_IMPORTED_MODULE_6__[\"default\"](blogSlider, {\n  slidesPerView: 4,\n  spaceBetween: 20,\n  autoplay: {\n    delay: 5000,\n  },\n  speed: 600,\n  autoplay: {\n    delay: 4000,\n  },\n  allowTouchMove: true,\n  navigation: {\n    nextEl: '.blog .nav-arrow-right',\n    prevEl: '.blog .nav-arrow-left',\n  },\n  breakpoints: {\n    0: {\n      slidesPerView: 1,\n      spaceBetween: 8,\n    },\n    576: {\n      slidesPerView: 1,\n    },\n    768: {\n      slidesPerView: 2,\n    },\n    992: {\n      slidesPerView: 3,\n    },\n    1200: {\n      slidesPerView: 4,\n    },\n  },\n});\n\n// reviews-slider\nconst reviewsSlider = document.querySelector('.reviews-slider');\nvar mySwiperReviews = new swiper__WEBPACK_IMPORTED_MODULE_6__[\"default\"](reviewsSlider, {\n  slidesPerView: 3,\n  spaceBetween: 10,\n  autoplay: {\n    delay: 5000,\n  },\n  speed: 600,\n  autoplay: {\n    delay: 4000,\n  },\n  allowTouchMove: true,\n  navigation: {\n    nextEl: '.reviews .nav-arrow-right',\n    prevEl: '.reviews .nav-arrow-left',\n  },\n});\n\n\nlet likeProductAll = document.querySelectorAll('.product__like-icon');\nlikeProductAll.forEach(el => {\n  el.addEventListener('click', () => {\n    el.classList.toggle('active');\n  });\n});\n\nlet likeOrderAll = document.querySelectorAll('.order-recommended__like-icon');\nlikeOrderAll.forEach(el => {\n  el.addEventListener('click', () => {\n    el.classList.toggle('active');\n  });\n});\n\nlet btnSidebarMoreAll = document.querySelectorAll('.cat-loadmore');\nbtnSidebarMoreAll.forEach(el => {\n  el.addEventListener('click', () => {\n    let elPar = el.closest('.accordion-body');\n    let sidebarWrapperItems = elPar.querySelector('.sidebar-items-sm');\n    sidebarWrapperItems.classList.toggle('active');\n    el.classList.toggle('active');\n  });\n});\n\nlet inputHasSubcatDependAll = document.querySelectorAll('.sidebar-item__head-wrapper>label');\ninputHasSubcatDependAll.forEach(el => {\n  el.addEventListener('click', () => {\n    let elPar = el.closest('.has-subcategory');\n    let elInput = elPar.querySelector('input');\n    let subcatInputAll = elPar.querySelectorAll('.sidebar-item__subcat input');\n\n    if (elInput.checked == true) {\n      subcatInputAll.forEach(elem => {\n        elem.checked = false;\n      });\n    } else {\n      subcatInputAll.forEach(elem => {\n        elem.checked = true;\n      });\n    }\n  });\n});\n\nvar range = document.getElementById('range');\nif (range) {\n  noUiSlider.create(range, {\n    start: [20000, 70000],\n    connect: true,\n    step: 1,\n    range: {\n      'min': 0,\n      'max': 100000\n    }\n  });\n  range.style.height = '4px';\n\n  var inputNumber_1 = document.getElementById('input-number-1');\n  var inputNumber_2 = document.getElementById('input-number-2');\n\n  range.noUiSlider.on('update', function (values, handle) {\n\n    var value = values[handle];\n\n    if (handle) {\n      inputNumber_2.value = Math.round(value);\n    } else {\n      inputNumber_1.value = Math.round(value);\n    }\n  });\n\n  inputNumber_1.addEventListener('change', function () {\n    range.noUiSlider.set([this.value, null]);\n  });\n\n  inputNumber_2.addEventListener('change', function () {\n    range.noUiSlider.set([null, this.value]);\n  });\n}\n\nlet likeBtn = document.querySelector('.like-wrapper');\n\nlikeBtn?.addEventListener('click', () => {\n  likeBtn.classList.toggle('active');\n});\n\nlet optionBtn = document.querySelector('.option-btn');\nlet addToCart = document.querySelector('.add-to-cart');\nlet variationInputAll = document.querySelectorAll('.input-box label');\nlet buttonAvailable = document.getElementById('button_2');\nlet buttonAvailableLg = document.getElementById('button-3');\nvariationInputAll.forEach(el => {\n  el.addEventListener('click', () => {\n\n    buttonAvailable.click();\n    if (buttonAvailableLg.classList.contains('collapsed')) {\n      buttonAvailableLg.click();\n    }\n\n    optionBtn.classList.add('hide');\n    addToCart.classList.add('show');\n\n    // ПК\n    let rowTableAvailableAll = document.querySelectorAll('.available-table tbody tr');\n    rowTableAvailableAll.forEach(elem => {\n      elem.classList.remove('active');\n      if (el.dataset.count == elem.dataset.count) {\n        elem.classList.add('active');\n      }\n    });\n    // мобила\n    let productAvailHeadAll = document.querySelectorAll('.product-avail__head');\n    productAvailHeadAll.forEach(elem => {\n      elem.classList.remove('active');\n      if (el.dataset.count == elem.dataset.count) {\n        if (elem.classList.contains('collapsed')) {\n          elem.click();\n        }\n      }\n    });\n  });\n});\n\nlet productAvailBtnLg = document.querySelector('.product-available-btn_lg');\nlet productAvailBtnSm = document.querySelector('.product-available-btn_sm');\nproductAvailBtnLg?.addEventListener('click', () => {\n  buttonAvailable.click();\n});\nproductAvailBtnSm?.addEventListener('click', () => {\n  if (buttonAvailableLg.classList.contains('collapsed')) {\n    buttonAvailableLg.click();\n  }\n});\n\n\n\n\nlet btnArticleCardLoadMore = document.querySelectorAll('.article-load-more');\nbtnArticleCardLoadMore.forEach(el => {\n  let elPar = el.closest('.article-card');\n  let elText = elPar.querySelector('.article-text');\n  // console.log(elText.offsetHeight);\n  // console.log(elPar.offsetHeight);\n  // if(elText.clientHeight > 50){\n  //   console.log('Ьольше а');\n  // }\n  el.addEventListener('click', () => {\n    elText.classList.add('active');\n    el.classList.add('remove');\n  });\n});\n\nlet sortBtnAll = document.querySelectorAll('.shop-sort');\nsortBtnAll.forEach(el => {\n  let elPar = el.closest('.sort-wrapper');\n  let elSortContent = elPar.querySelector('ul');\n  el.addEventListener('click', () => {\n    elSortContent.classList.toggle('active');\n  });\n});\n\nlet arrowMenuAll = document.querySelectorAll('.arrow-btn-more');\narrowMenuAll.forEach(el => {\n  let elPar = el.closest('li');\n  let elContent = elPar.querySelector('.header__nav-subcat-wrapper ');\n  el.addEventListener('click', () => {\n    elContent.classList.toggle('active');\n  });\n});\n\nlet btnCloseSubcat = document.querySelectorAll('.subcat-close');\nbtnCloseSubcat.forEach(el => {\n  let elPar = el.closest('li');\n  let elContent = elPar.querySelector('.header__nav-subcat-wrapper ');\n  el.addEventListener('click', () => {\n    elContent.classList.toggle('active');\n  });\n});\n\nlet fixedCart = document.querySelector('.fixed-cart');\nlet noFixedCart = document.querySelector('.no-fixed-cart');\n\nif (noFixedCart) {\n  // fixedCart.classList.add('active');\n\n  addEventListener(\"scroll\", () => {\n    var distanceToTop = noFixedCart.getBoundingClientRect().top;\n    let footer = document.querySelector('footer');\n\n    if (distanceToTop <= 1) {\n      fixedCart.classList.add('active');\n      footer.classList.add('active');\n\n    } else {\n      fixedCart.classList.remove('active');\n      footer.classList.remove('active');\n    }\n  });\n}\n\nlet tabContent = document.getElementById('pills-tabContent');\nconst mediaQuery991 = window.matchMedia('(max-width: 991px)');\nlet availTable = document.querySelector('.avail-accord');\nlet reviewsWrapper = document.querySelector('.reviews-wrapper');\nlet sodebarItemsParams = document.querySelector('.sidebar-items-params');\nlet getMain = document.querySelector('.get-main');\nlet get1 = document.querySelector('.get-1');\nlet get2 = document.querySelector('.get-2');\nlet get3 = document.querySelector('.get-3');\nlet contentTableAll = document.querySelectorAll('.content-table');\n\n\nif (mediaQuery991.matches && tabContent) {\n  tabContent.classList.remove('tab-content');\n  availTable.classList.add('collapse');\n  sodebarItemsParams.classList.add('collapse');\n  reviewsWrapper.classList.add('collapse');\n  get1.classList.add('collapse');\n  get2.classList.add('collapse');\n  get3.classList.add('collapse');\n  getMain.classList.add('collapse');\n\n  contentTableAll.forEach(el => {\n    el.classList.add('collapse');\n  });\n\n}\nif (mediaQuery991.matches && reviewsSlider) {\n  mySwiperReviews.destroy();\n}\n\nlet btnContentMore = document.querySelector('.btn-content-more');\nbtnContentMore?.addEventListener('click', () => {\n  let elPar = btnContentMore.closest('.content');\n  let elContent = elPar.querySelector('.content-block');\n  elContent.classList.add('active');\n  btnContentMore.style.display = 'none';\n});\n\nlet btnTableMoreAll = document.querySelectorAll('.btn-table-more');\nbtnTableMoreAll?.forEach(el => {\n  el.addEventListener('click', () => {\n    let elPar = el.closest('.table-wrapper');\n    elPar.classList.add('active');\n    el.style.display = 'none';\n  });\n});\n\nlet personalProductsWrapperAll = document.querySelectorAll('.history-item__products');\npersonalProductsWrapperAll?.forEach(el => {\n  let elPar = el.closest('.history-item__products-wrapper');\n  let buttonProductMore = elPar.querySelector('.history-item__products-more');\n  let productAll = el.querySelectorAll('li');\n\n  if (productAll.length <= 3) {\n    buttonProductMore.style.display = 'none';\n  } else {\n    buttonProductMore.addEventListener('click', () => {\n      el.classList.add('active');\n      buttonProductMore.style.display = 'none';\n    });\n  }\n\n});\n\n// product logic variation\nlet productAddToCartBtn = document.querySelector('.product-add-to-cart');\nlet productInputWrapper = document.querySelector('.product-input-wrapper');\nproductAddToCartBtn?.addEventListener('click', () => {\n  let variationInputFieldAll = document.querySelectorAll('.input-box input:checked');\n  if (variationInputFieldAll.length == 0) {\n    optionBtn.classList.remove('hide');\n    productAddToCartBtn.classList.remove('show');\n    productInputWrapper.classList.add('active');\n    setTimeout(() => {\n      productAddToCartBtn.classList.add('show');\n      optionBtn.classList.add('hide');\n      productInputWrapper.classList.remove('active');\n    }, \"5000\");\n  }\n});\n\n// matchHeight\n(function matchHeight() {\n  //Grab divs with the class name 'match-height'\n  var getDivs = document.getElementsByClassName('match-height');\n\n  //Find out how my divs there are with the class 'match-height' \n  var arrayLength = getDivs.length;\n  var heights = [];\n\n  //Create a loop that iterates through the getDivs variable and pushes the heights of the divs into an empty array\n  for (var i = 0; i < arrayLength; i++) {\n    heights.push(getDivs[i].offsetHeight);\n  }\n\n  //Find the largest of the divs\n  function getHighest() {\n    return Math.max(...heights);\n  }\n\n  //Set a variable equal to the tallest div\n  var tallest = getHighest();\n\n  //Iterate through getDivs and set all their height style equal to the tallest variable\n  for (var i = 0; i < getDivs.length; i++) {\n    getDivs[i].style.height = tallest + \"px\";\n  }\n})();\n\n\n\nvar disabledDays = [0, 6];\nnew air_datepicker__WEBPACK_IMPORTED_MODULE_4__[\"default\"]('#calendar', {\n  autoClose: 'true',\n  minDate: new Date(),\n  onRenderCell({ date, cellType }) {\n    // console.log('123');\n    if (cellType == 'day') {\n      var day = date.getDay(),\n        isDisabled = disabledDays.indexOf(day) != -1;\n\n      return {\n        disabled: isDisabled\n      }\n    }\n  }\n});\n\nlet certCheck = document.getElementById('order_sale_1');\nlet certLabel = document.getElementById('order_label_1');\nlet certNumber = document.getElementById('cert-number-block');\n\nlet couponCheck = document.getElementById('order_sale_2');\nlet couponLabel = document.getElementById('order_label_2');\nlet couponNumber = document.getElementById('coupon-number-block');\n\nlet bonusCheck = document.getElementById('order_sale_3');\nlet bonusLabel = document.getElementById('order_label_3');\nlet bonusNumber = document.getElementById('bonus-number-block');\n\ncertLabel?.addEventListener('click', (el) => {\n  if (certCheck.checked == true) {\n    certNumber?.classList.remove('active');\n  } else {\n    certNumber?.classList.add('active');\n  }\n});\n\ncouponLabel?.addEventListener('click', (el) => {\n  if (couponCheck.checked == true) {\n    couponNumber?.classList.remove('active');\n  } else {\n    couponNumber?.classList.add('active');\n  }\n});\n\nbonusLabel?.addEventListener('click', (el) => {\n  if (bonusCheck.checked == true) {\n    bonusNumber?.classList.remove('active');\n  } else {\n    bonusNumber?.classList.add('active');\n  }\n});\n\nlet bonusActCheck = document.getElementById('order_sale_bonus');\nlet bonusActLabel = document.getElementById('order_label_bonus');\nlet bonusEditWrapper = document.querySelector('.bonus-edit-wrapper');\n\nbonusActLabel?.addEventListener('click', (el) => {\n  if (bonusActCheck.checked == true) {\n    // bonusNumber?.classList.remove('active');\n    bonusEditWrapper?.classList.remove('active');\n    bonusEditAfterAction?.classList.remove('active');\n    bonusEditBeforeAction.classList.remove('hide');\n  } else {\n    bonusEditWrapper?.classList.add('active');\n  }\n});\n\nlet editBtnBonus = document.getElementById('edit-btn-bonus');\nlet bonusEditAfterAction = document.querySelector('.bonus-edit-after-action');\nlet bonusEditBeforeAction = document.querySelector('.bonus-edit-before-action');\nlet changeBonusTotal = document.getElementById('change-bonus-total');\neditBtnBonus?.addEventListener('click', () => {\n  bonusEditAfterAction.classList.add('active');\n  bonusEditBeforeAction.classList.add('hide');\n});\n\nlet editBonusSubmit = document.querySelector('.edit-bonus-submit');\neditBonusSubmit?.addEventListener('click', () => {\n  let changeBonusInput = document.querySelector('.change-bonus');\n  changeBonusTotal.textContent = changeBonusInput.value;\n  bonusEditAfterAction?.classList.remove('active');\n  bonusEditBeforeAction.classList.remove('hide');\n});\n\nlet addSertBtn = document.getElementById('add_sert_btn');\nlet certNumberAction = document.querySelector('.cert-number-action');\naddSertBtn?.addEventListener('click', () => {\n  addSertBtn.style.display = 'none';\n  certNumberAction.classList.add('active');\n});\n\nlet certBtnAction = document.getElementById('cert-btn-action');\nlet certNumberInput = document.querySelector('#cert-number');\ncertBtnAction?.addEventListener('click', () => {\n  if (certNumberInput.value == '') {\n    return;\n  } else {\n    certNumberAction.classList.remove('active');\n    addSertBtn.style.display = 'block';\n  }\n});\n\n//# sourceURL=webpack://gulp-2022/./src/js/app.js?");
...
/***/ "./src/js/modules/nouislider.min.js":
/*!******************************************!*\
  !*** ./src/js/modules/nouislider.min.js ***!
  \******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
